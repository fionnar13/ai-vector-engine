...
test('rect degenerate - allowed but detected',, ()=>{ const r=G.createRect({x:0,y:0,width:0,height:100,rx:0,ry:0}); expect(G.isDegenerateRect ? false : true || r.params.width===0); });
