...
import { vec2, add, subtract, multiply, dot, cross, length, normalize, distance } from '../src-js/vec2.js';
...
function expectClose(a,b,tol=1e-9){ if(Math.abs(a-b)>tol) throw new Error(`Expected ${a} close to ${b} tol ${tol}`); }
